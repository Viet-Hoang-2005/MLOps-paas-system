...
export const toast = {
  success: (message: unknown) =>
    globalToastCallback?.("success", normalizeToastMessage(message)),
  error: (message: unknown) =>
    globalToastCallback?.("error", normalizeToastMessage(message)),
  warning: (message: unknown) =>
    globalToastCallback?.("warning", normalizeToastMessage(message)),
};
