        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="flex flex-col h-full w-full">
            <div className="flex-1 space-y-5">
              ...
              />
              <div>
                <label className="text-style-body-strong text-color-foreground mb-2 block">
                  {t("editModel.accessMode")}
                </label>
                <Picker
                  ...
                  onChange={(v) =>
                    setField(
                      "access_mode",
                      v as ModelProjectFormValues["access_mode"],
                    )
                  }
                  options={[
                    {
                      value: "private",
                      title: t("editModel.privateTitle"),
                      description: t("editModel.privateDescription"),
                    },
                    {
                      value: "public",
                      title: t("editModel.publicTitle"),
                      description: t("editModel.publicDescription"),
                    },
                  ]}
                />
              </div>
