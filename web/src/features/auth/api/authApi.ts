...
export const requestOTP = async (
  ...
  (await apiClient.post<OTPResponse>("/auth/register/request-otp/", payload))
    .data;
...
export const verifyOTP = async (
  ...
  (
    await apiClient.post<OTPVerifyResponse>(
...
export const completeRegistration = async (
  ...
  return (
    await apiClient.post<AuthResponse>("/auth/register/complete/", formData, {
...
export const loginGitHub = async (
  ...
  (
    await apiClient.post<AuthResponse>("/auth/oauth/github/", {
      code,
...
export const forgotPasswordOTP = async (email: string): Promise<OTPResponse> =>
  (
    await apiClient.post<OTPResponse>("/auth/password-reset/request-otp/", {
      email,
    })
  ).data;
