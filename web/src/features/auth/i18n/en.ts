export const authEn = {
  login: {
    ...
    googleMissing: "VITE_GOOGLE_CLIENT_ID is not configured.",
    githubMissing: "GitHub OAuth is not configured.",
  ...
  otp: {
    ...
    expired: "Invalid or expired OTP. Please try again.",
    missing: "Didn't receive the code?",
  ...
  recovery: {
    ...
    send: "Send OTP",
    sendFailed: "Failed to send OTP. Please check your email and try again.",
    startOver: "Start over",
    newTitle: "Create a new password",
    newDescription: "Choose a strong password for {{email}}.",
    ...
    resetFailed: "Failed to reset password. Please request a new OTP.",
    verified: "OTP verified. Please set a new password.",
  },
  profile: {
    back: "Back to sign up",
    title: "Complete your profile",
    registering: "Registering as {{email}}",
    avatar: "Avatar",
    avatarDescription: "Upload and crop a profile image",
    fullName: "Full Name",
    ...
    cropFailed: "Unable to crop avatar. Please try another image.",
  ...
  github: {
    ...
    invalidState: "GitHub OAuth state is invalid. Please try again.",
